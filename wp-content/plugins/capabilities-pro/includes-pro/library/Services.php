...
if (!class_exists('EDD_SL_Plugin_Updater')) {
    require_once(PUBLISHPRESS_CAPS_ABSPATH . '/vendor/publishpress/edd-license-handler/EDD_SL_Plugin_Updater.php');
}
...
foreach([
    ...
    if (!class_exists('\PublishPress\EDD_License\Core\\' . $class)) {
        require_once(PUBLISHPRESS_CAPS_ABSPATH . "/vendor/publishpress/wordpress-edd-license-integration/src/core/$class.php");
    }
}
