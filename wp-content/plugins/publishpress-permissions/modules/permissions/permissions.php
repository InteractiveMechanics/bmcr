        ...
        public function filter_all_capabilities($capabilities)
        {
            $newCapabilities = [
                ...
                'pp_set_notification_channel'  => [
                    'groups' => ['publishpress'],
                    'label'  => __('Select notification channel in the profile page', 'publishpress-permissions'),
                ],
                'read'                         => [
                    'groups' => ['publishpress'],
                    'label'  => __('Access the Dashboard, the admin bar, and the “Your Profile” page', 'publishpress-permissions'),
                ],
                'promote_users'                => [
                    'groups' => ['publishpress'],
                    'label'  => __('Change the role of other users', 'publishpress-permissions'),
                ],
                ...
                'upload_files'           => [
                    'groups' => ['posts'],
                    'label'  => __('Upload files', 'publishpress-permissions'),
                ],
