...
class CirclesHooksAdmin
{
    ...
    {
        $pp_caps['pp_exempt_read_circle'] = __('Visibility Circle membership does not limit viewing access', 'ppcc');
        $pp_caps['pp_exempt_edit_circle'] = __('Editorial Circle membership does not limit editing access', 'ppcc');
        return $pp_caps;
    }
}
