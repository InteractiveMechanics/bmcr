...
div.wrap ul.subsubsub span.count, div.wrap #icl_subsubsub span.count, div.icl_subsubsub span.count {display:none;}
    ...
    {
        $opt_captions['mirror_post_translation_exceptions'] = __('Mirror Post Exceptions to translations', 'wpml_pp');
        $opt_captions['mirror_term_translation_exceptions'] = __('Mirror Term Exceptions to translations', 'wpml_pp');
        return $opt_captions;
    }
