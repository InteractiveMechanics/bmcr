...
class HooksAdmin
{
    ...
    function operation_object($op_obj, $operation, $post_type)
    {
        if ('publish_topics' == $operation) {
            $op_obj = (object)[
                'label' => __('Create Topics in', 'ppp'), 
                'noun_label' => __('Topic Creation', 'ppp'), 
                'abbrev' => __('Create Topic', 'ppp')
            ];

        } elseif ('publish_replies' == $operation) {
            $op_obj = (object)[
                'label' => __('Submit Replies in', 'ppp'), 
                'noun_label' => __('Reply Submission', 'ppp'), 
                'abbrev' => __('Submit Reply', 'ppp')
            ];
