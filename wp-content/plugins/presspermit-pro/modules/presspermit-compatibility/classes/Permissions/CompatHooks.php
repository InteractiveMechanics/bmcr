...
class CompatHooks
{
    ...
    function default_options($def)
    {
        $new = [
            'topics_teaser' => 1,
            'tease_topic_replace_content' => __("[This topic requires additional permissions or membership.]", 'ppp'),
            'tease_topic_replace_other_content' => __("[...]", 'ppp'),
            'tease_topic_replace_content_anon' => __("[This topic requires site login.]", 'ppp'),
            'tease_topic_replace_other_content_anon' => __("[login required]", 'ppp'),
            'tease_reply_replace_content' => __("[This topic requires additional permissions or membership.]", 'ppp'),
            'tease_reply_replace_other_content' => __("[...]", 'ppp'),
            'tease_reply_replace_content_anon' => __("[This reply requires site login.]", 'ppp'),
            'tease_reply_replace_other_content_anon' => __("[login required]", 'ppp'),
