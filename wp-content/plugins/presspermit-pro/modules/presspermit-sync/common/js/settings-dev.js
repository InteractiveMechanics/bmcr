jQuery(document).ready(function ($) {
    $('#sync_posts_to_users').change(function () {
    ...
    $('td.pp-sync-now input[type="checkbox"]').change(function () {
        $('input.pp-sync-now-button').show();
    });
    $('#sync_posts_to_users_settings input.sync-enable-type').change(function () {
    ...
    $('select.ppp-suggestion').click(function () {
        if ($(this).val() == '(other)') {
