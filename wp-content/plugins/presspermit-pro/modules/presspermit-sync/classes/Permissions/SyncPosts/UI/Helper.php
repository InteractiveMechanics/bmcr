...
class Helper
{
    public static function teamPluginNotices()
    {
        ...
        if ($matched) {
            ...
            $message = sprintf(
                __('You seem to be using a Team / Staff plugin. To have PressPermit synchronize posts to users and give them editing permission, go to %1$sPermissions > Settings > Sync Posts%2$s', 'ppsync'), 
            ...
            <script type="text/javascript">
                jQuery(document).ready(function ($) {
                    $('button.notice-dismiss').click(function()
                    {
