...
class PostEdit 
{
    function __construct() {
        ...
        if ($post_type = PWP::findPostType())
            add_filter("get_user_option_meta-box-order_{$post_type}", [$this, 'flt_metabox_order'], 10, 3);
    ...
    public function flt_metabox_order($result, $option, $user)
    {
    ...
    public function act_object_edit_scripts()
    {
        ...
        wp_localize_script('presspermit-object-edit', 'ppObjEdit', [
            ...
            'nowCaption' => __('Current Time', 'pps'),
        ]);
