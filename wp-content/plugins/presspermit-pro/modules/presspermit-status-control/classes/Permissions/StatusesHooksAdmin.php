...
class StatusesHooksAdmin 
{
    ...
    function actBuildMenu()
    {
        ...
        if (in_array($pp_page, ['presspermit-status-new', 'presspermit-status-edit'], true)) {
            ...
            $titles = [
                'presspermit-status-new' => __('Add New Status', 'pps'),
                'presspermit-status-edit' => __('Edit Status', 'pps'),
            ];
    ...
    {
        if (!defined('PPS_NATIVE_CUSTOM_STATI_DISABLED') || defined('PRESSPERMIT_COLLAB_VERSION')) {
