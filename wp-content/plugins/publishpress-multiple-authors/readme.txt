...
4. Search for "PublishPress Multiple Authors";
5. Install PublishPress Multiple Authors plugin;
6. Activate the PublishPress Multiple Authors plugin.

**Manually uploading the plugin to your repository**

1. Download the PublishPress Multiple Authors plugin zip file;
...
5. Activate the PublishPress Multiple Authors plugin.
