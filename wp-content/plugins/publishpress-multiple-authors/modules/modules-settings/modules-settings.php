...
if ( ! class_exists('MA_Modules_Settings')) {
    ...
    class MA_Modules_Settings extends Module
    {
        ...
        public function __construct()
        {
            ...
            $args = [
                'title'                => __('Authors Settings', 'publishpress-multiple-authors'),
        ...
        public function print_configure_view()
        {
            ...
            <form class="basic-settings"
                ...
                if ( ! empty($tabs)) {
                    echo '<ul id="publishpress-multiple-authors-settings-tabs" class="nav-tab-wrapper">';
                    $i = 0;
                ...
                <?php if ($featuresCount > 0) : ?>
                    <div id="modules-wrapper">
                        <h3><?php echo __('Features', 'publishpress-multiple-authors'); ?></h3>
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                <th scope="row"><?php echo __('Enabled features',
                                        'publishpress-multiple-authors'); ?></th>
                                <td>
