...
class Plugin
{
    ...
    public function __construct()
    {
        ...
        add_action('multiple_authors_upgrade',
        ...
        add_action('pp_multiple_authors_show_author_box', [$this, 'action_echo_author_box'], 10, 4);
        ...
        add_filter('term_link',
            ['MultipleAuthors\\Classes\\Content_Model', 'filter_term_link'], 10, 3);
        add_filter('author_link',
            ['MultipleAuthors\\Classes\\Content_Model', 'filter_author_link'], 10, 3);
        add_filter('the_author_display_name',
            ['MultipleAuthors\\Classes\\Content_Model', 'filter_author_display_name'], 10, 2);
        add_filter('update_term_metadata',
            ['MultipleAuthors\\Classes\\Content_Model', 'filter_update_term_metadata'], 10,
            4);
        ...
        add_filter('user_row_actions',
            ['MultipleAuthors\\Classes\\Author_Editor', 'filter_user_row_actions'], 10, 2);
        add_filter('author_row_actions',
            ['MultipleAuthors\\Classes\\Author_Editor', 'filter_author_row_actions'], 10,
            2);
        ...
        add_action('user_register',
            ['MultipleAuthors\\Classes\\Author_Editor', 'action_user_register'], 20);
        add_action('author_term_new_form_tag',
            ['MultipleAuthors\\Classes\\Author_Editor', 'action_new_form_tag'], 10);
        add_filter('wp_insert_term_data',
            ['MultipleAuthors\\Classes\\Author_Editor', 'filter_insert_term_data'], 10, 3);
        add_filter('created_author',
            ['MultipleAuthors\\Classes\\Author_Editor', 'action_created_author'], 10, 2);
        ...
        add_filter('handle_bulk_actions-edit-author',
            ['MultipleAuthors\\Classes\\Author_Editor', 'handle_author_bulk_actions'], 10,
            3);
        ...
        add_filter('posts_where',
            ...
            10, 2);
        add_filter('posts_join', ['MultipleAuthors\\Classes\\Query', 'filter_posts_join'],
            10,
            2);
        add_filter('posts_groupby',
            ['MultipleAuthors\\Classes\\Query', 'filter_posts_groupby'], 10, 2);
        ...
        add_action('add_meta_boxes',
            ['MultipleAuthors\\Classes\\Post_Editor', 'action_add_meta_boxes_late'], 100);
        ...
        add_filter('ppma_get_author_data',
            ['MultipleAuthors\\Classes\\Content_Model', 'filter_ma_get_author_data'], 10,
            3);
    ...
    public function ppma_test () {
        echo '<b>PublishPress Multiple Authors:</b> shortcode rendered successfully!';
    }
    ...
    public function action_init()
    {
        ...
        // Allow PublishPress Multiple Authors Pro to be easily translated
    ...
    public function update_footer_admin($footer)
    {
        if ($this->shouldDisplayFooter()) {
            ...
            $html .= $this->print_default_footer($legacyPlugin->modules->multiple_authors,
                false);
        ...
        if ($showFooter) {
            ...
            $html = $twig->render(
                ...
                [
                    ...
                    'plugin_name'    => __('PublishPress', 'publishpress-multiple-authors'),
                    'plugin_slug'    => 'publishpress',
                    'plugin_url'     => PP_MULTIPLE_AUTHORS_URL,
                    'rating_message' => __('If you like %s please leave us a %s rating. Thank you!', 'publishpress-multiple-authors'),
                ]
            );
        }
    ...
    /**
     * If we're forcing PublishPress Multiple Authors Pro to just do taxonomy queries, we still
    ...
    public function enqueue_scripts($hook_suffix)
    {
        ...
        wp_enqueue_style('pressshack-style',
            PP_MULTIPLE_AUTHORS_ASSETS_URL . '/css/pressshack-admin.css',
            [],
            PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION
        );

        wp_enqueue_style('multiple-authors-style',
            PP_MULTIPLE_AUTHORS_ASSETS_URL . '/css/multiple-authors.css',
            [],
            PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION
        );
        ...
        wp_enqueue_style(
            ...
            PP_MULTIPLE_AUTHORS_ASSETS_URL . '/lib/chosen-v1.8.3/chosen.min.css',
            false,
            PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION,
            'all'
        );
        ...
        wp_enqueue_script(
            'multiple-authors-chosen',
            PP_MULTIPLE_AUTHORS_ASSETS_URL . '/lib/chosen-v1.8.3/chosen.jquery.min.js',
            ['jquery'],
            PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION
        );

        wp_enqueue_script('multiple-authors-select2',
            PP_MULTIPLE_AUTHORS_ASSETS_URL . '/lib/select2/js/select2.min.js',
            ['jquery'],
            PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION
        );

        wp_enqueue_style('multiple-authors-select2',
            PP_MULTIPLE_AUTHORS_ASSETS_URL . '/lib/select2/css/select2.min.css',
            [],
            PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION
        );

        wp_enqueue_script('multiple-authors-js',
            PP_MULTIPLE_AUTHORS_ASSETS_URL . '/js/multiple-authors.js',
        ...
        $js_strings = [
            ...
            'help_text'                     => __('Click on an author to change them. Drag to change their order. Click on <strong>Remove</strong> to remove them.',
                'publishpress-multiple-authors'),
            'confirm_delete_mapped_authors' => __('Are you sure you want to delete the authors profiles mapped to users? This action can\'t be undone.',
                'publishpress-multiple-authors'),
            'confirm_delete_guest_authors'  => __('Are you sure you want to delete the guest authors profiles? This action can\'t be undone.',
                'publishpress-multiple-authors'),
            'confirm_create_post_authors'   => __('Are you sure you want to create author profiles for the missed post authors?',
                'publishpress-multiple-authors'),
            'confirm_create_role_authors'   => __('Are you sure you want to create authors for the selected roles?',
                'publishpress-multiple-authors'),
            'ajax_get_author_data_url'      => admin_url('admin-ajax.php?action=author_get_user_data&nonce=' . $nonce),
            'menu_slug'                     => $legacyPlugin->get_menu_slug(),
            'wait_text'                     => __('Please, wait...', 'publishpress-multiple-authors'),
            'error_on_request'              => __('Sorry, the request returned an error.',
                'publishpress-multiple-authors'),
        ];
