...
class Code
{
    ...
    public static function render($field = [])
    {
        ...
        if (empty($layoutCode)) {
            $layoutCode = file_get_contents(PP_MULTIPLE_AUTHORS_BASE_PATH . 'twig/author_layout/default.twig');
        }
        ?>
        ...
        <script src="<?php echo PP_MULTIPLE_AUTHORS_ASSETS_URL . '/lib/ace/ace.js'; ?>?v=<?php echo PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION; ?>"
                type="text/javascript"
                charset="utf-8"></script>
        <script src="<?php echo PP_MULTIPLE_AUTHORS_ASSETS_URL . '/lib/ace/mode-twig.js'; ?>?v=<?php echo PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION; ?>"
                type="text/javascript"
                charset="utf-8"></script>
        <script>
            jQuery(function ($) {
