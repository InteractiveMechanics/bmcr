...
class LegacyPlugin
{
    ...
    private $menu_slug = 'ppma-authors';

    private $added_menu_page = false;
    ...
    {
        $defaultDirs = [
            'modules-settings'      => PP_MULTIPLE_AUTHORS_MODULES_PATH,
            'settings'              => PP_MULTIPLE_AUTHORS_MODULES_PATH,
            'multiple-authors'      => PP_MULTIPLE_AUTHORS_MODULES_PATH,
            'author-custom-fields'  => PP_MULTIPLE_AUTHORS_MODULES_PATH,
            'author-custom-layouts' => PP_MULTIPLE_AUTHORS_MODULES_PATH,
        ];
    ...
    public function register_module($name, $args = [])
    {
        ...
        $defaults = [
            ...
            'configure_link_text'  => __('Configure', 'publishpress-multiple-authors'),
            ...
            'messages'             => [
                ...
                'nonce-failed'        => __('Cheatin&#8217; uh?', 'publishpress-multiple-authors'),
                'invalid-permissions' => __('You do not have necessary permissions to complete this action.',
                    'publishpress-multiple-authors'),
                'missing-post'        => __('Post does not exist', 'publishpress-multiple-authors'),
            ],
    ...
    public function action_ini_for_admin()
    {
        ...
        if ($previous_version && version_compare($previous_version, PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION, '<')) {
            foreach ($this->modules as $mod_name => $mod_data) {
        ...
        update_option($versionOption, PUBLISHPRESS_MULTIPLE_AUTHORS_VERSION);
    ...
    {
        return apply_filters('multiple_authors_admin_menu_slug', $this->menu_slug);
    }
